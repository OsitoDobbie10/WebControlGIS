...
import {BTNSave,UseCategorias,UseUsuarioStore} from "../../index";
import {v} from "../../styles/variables"
import Swal from "sweetalert2";
const CardEliminarTodo = () => {
const eliminar = UseCategorias(stade=>stade.eliminarCategoriasTodas);
...
const EliminarData = async()=>{
  Swal.fire({
    ...
    confirmButtonText: "Si, eliminar",}).then(async(result) =>{
  ...
  return (
    <Container>
      ...
      <BTNSave titulo="Eliminar" bgcolor="rgba(247, 92, 92, 0.87)" funcion={EliminarData}/>
      <div className="contentImg">
        <img src={v.eliminarImg} />
      </div>
    </Container>
  )
}
...
`;
export default CardEliminarTodo
